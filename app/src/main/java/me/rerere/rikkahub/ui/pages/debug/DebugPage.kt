...
@Composable
private fun LoggingPage(vm: DebugVM) {
    ...
    Column(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    text = "Enable RAG Logging",
                    style = MaterialTheme.typography.titleMedium
                )
                Text(
                    text = "Log detailed retrieval info to Logcat (tag: RAG)",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
            androidx.compose.material3.Switch(
                checked = settings.enableRagLogging,
                onCheckedChange = {
                    vm.updateSettings(settings.copy(enableRagLogging = it))
                }
            )
        }
...
@Composable
private fun PromptPage(vm: DebugVM) {
